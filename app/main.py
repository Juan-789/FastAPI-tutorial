...
models.Base.metadata.create_all(bind=engine) # generates tables in postgres
...
while True:     # tries to connect to host until it does
    try:
        connection = psycopg2.connect(host='localhost', database='fastapi', user='postgres', password='Diccionario1', cursor_factory=RealDictCursor)
